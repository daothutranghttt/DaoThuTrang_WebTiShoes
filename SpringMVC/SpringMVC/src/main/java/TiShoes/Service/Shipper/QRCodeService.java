...
public class QRCodeService {
	...
	public String create_qr_code (String order_id) {
		try {
            ...
            String filePath = "F:\\DATN-2023\\SpringMVC\\src\\main\\webapp\\assets\\images\\qrcode\\"+name;
	...
	public String create_bar_code (String order_id) {
		try {
            ...
            String filePath = "F:\\DATN-2023\\SpringMVC\\src\\main\\webapp\\assets\\images\\barcode\\"+name;
            String charset = "UTF-8"; // or "ISO-8859-1"
            Map < EncodeHintType, ErrorCorrectionLevel > hintMap = new HashMap < EncodeHintType, ErrorCorrectionLevel > ();
            hintMap.put(EncodeHintType.ERROR_CORRECTION, ErrorCorrectionLevel.L);
            BitMatrix matrix = new MultiFormatWriter().encode(
