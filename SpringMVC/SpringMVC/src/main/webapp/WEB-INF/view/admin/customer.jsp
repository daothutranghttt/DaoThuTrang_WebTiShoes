	...
	<div class="admin-body">
		...
		<!-- ADD NEW USER -->
			...
			<c:if test="${ addnewuser == 'false' }">
				...
				<form action="/SpringMVC/admin/customer/add-new-user/savefile" method="post" enctype="multipart/form-data">
				...
				$('.ok').click(function() {
					...
					if(exists_when_update(rolename)) {
						...
						xhr.onload = function() {
							...
							$('.ok').click(function() {
								$(".message-notify").addClass("none");
								window.location.assign("/SpringMVC/admin/role");
							});
						};
						xhr.send();
					}
