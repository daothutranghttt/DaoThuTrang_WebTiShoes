	...
	<script type="text/javascript">
	    ...
	    scanner.addListener('scan',function(content){
	    	if(Number.isInteger(parseInt(content))) {
	    		 window.location.href="/SpringMVC/shipper/confirm-delivery/" +content;
	    	} else {
	    		 window.location.href="/SpringMVC/shipper/confirm-delivery/0";
	    	}
	    });
...
<c:if test="${ delivered == 'false' }">
	<script type="text/javascript">
		var delay = 1000; 
		setTimeout(function(){ window.location = "/SpringMVC/shipper/confirm-delivery"; }, delay);
	</script>
</c:if>
<script
