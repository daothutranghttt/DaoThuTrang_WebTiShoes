...
<title>Login :) ?</title>
<link rel="stylesheet"
	href="<c:url value='/assets/css/shipper-login.css'/>">
...
<body>
	...
	if (session.getAttribute("shipperID") != null) {
		response.sendRedirect("/SpringMVC/shipper");
	}
	%>
	...
	<div class="caixa__login">
		<h2>Shipper</h2>
		<form id="my_form" method="post" action="/SpringMVC/shipper/login">
	...
	<script type="text/javascript">
		function login() {
			...
			if (username == "") {
				...
				$('#my_form').attr('action', '/SpringMVC/shipper/login');
