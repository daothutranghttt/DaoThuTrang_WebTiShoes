...
<body style="color: white;">
            ...
            <div class="info-contact">
                ...
                <div class="mail-contact">
                    ...
                    <div class="content-contact">
                        ...
                        <div class="line-address">daothutrang.httt@gmail.com</div>
                    </div>
                </div>
            </div>
    ...
    <footer>
        <form action="" method="post">
            <div class="footer">
                <div class="logo-footer">
                    <a href="index.html"><img class="logo-footer" src="images/logo/logo_footer.jpg"
                            alt="logo-footer"></a>
                    <div class="shop-name">
                        <p class="text-shadow"><a href="index.html">TI SHOES</a></p>
                    </div>
                </div>
                    ...
                    <div class="content-footer-sub">
                        <div class="col1">
                            ...
                            <div class="content-col">
                                <a href="#">TI SHOES Community</a> <br>
                                <a href="#">TI SHOES Agency</a>
                            </div>
                        </div>
                        <div class="col2">
                            ADDRESS
                            <div class="content-col">
                                daothutrang.httt@gmail.com <br>
                                Thu Trang - 0346643755
                            </div>
                        </div>
                        <div class="col3">
                            FOLLOW
                            <div class="follow-app">
                                <a href="https://www.facebook.com/DaoThuTrang2001"><img src="images/icons/facebook60.png"
                                        alt="facebook60" class="app"></a>
                                <a href="https://github.com/daothutranghttt"><img
                                        src="images/icons/instagram60.png" alt="instagram60" class="app"></a>
                                <a href="https://www.youtube.com/channel/UC1wqB1nzPg5O439cTfqRU8A"><img
            ...
            <hr class="copyright">
            <div class="footer-copyright">TI SHOES Â© 2022 All rights reserved.</div>
        </form>
    </footer>
