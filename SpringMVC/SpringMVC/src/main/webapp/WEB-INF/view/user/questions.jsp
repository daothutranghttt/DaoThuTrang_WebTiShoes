            ...
            <div class="list-questions">
                ...
                <div class="question" id="question3" onclick="show(3);">
                    ...
                    <div class="answer" id="answer3">
                        Hi, Ti Shoes does not have a warranty policy for the product. I am very sorry and hope for
                        your understanding.
                        <hr>
                    </div>
                </div>
                ...
                <div class="question" id="question6" onclick="show(6);">
                    ...
                    <div class="answer" id="answer6">
                        For all money transfers from Ti Shoes to the Shop, the transfer fee will be borne
                        by the Shop. Currently, Ti Shoes stipulates a household remittance fee of 1$/transaction.
                        <hr>
                    </div>
                </div>
                <div class="question" id="question7" onclick="show(7);">
                    <h6 class="question">
                        7. Does Ti Shoes have delivery timers?</h6>
                    <div class="answer" id="answer7">
                        Currently, Ti Shoes does not deliver timers. However, Ti Shoes can ensure morning
                        delivery,
                ...
                <div class="question" id="question8" onclick="show(8);">
                    ...
                    <div class="answer" id="answer8">
                        If at the time of delivery, the customer is busy, Ti Shoes will postpone and re-deliver on
                        Ti Shoes always tries to re-deliver and assist customers with successful delivery. However,
                        for orders that are delayed
                        more than 3 times by customers, Ti Shoes will change the order status to Undelivered and
                ...
                <div class="question" id="question10" onclick="show(10);">
                    <h6 class="question">
                        10. Does Ti Shoes accept refunded product returns?</h6>
                    <div class="answer" id="answer10">
                        Hi, Ti Shoes reserves the right to receive returned products for a refund but only in cases
                        where the problem or manufacturing
                        defect is on Ti Shoes's side and the product or similar product is out of stock.
                        <hr>
                    </div>
                </div>
            </div>
