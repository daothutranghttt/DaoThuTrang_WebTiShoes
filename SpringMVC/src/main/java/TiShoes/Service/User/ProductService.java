...
//#######################################################################################3#########################
	...
	public List<Product> get_selling_prod() {
	...
	public HashMap<Integer, List<Product>> get_product_page(List<Product> li) {
		HashMap<Integer, List<Product>> hm = new LinkedHashMap<>();
		int count = 0;
		int c = 1;
	...
	public static void main(String[] args) {
		ProductService p = new ProductService();
		List<Product> li = p.get_selling_prod();
		for (Product pr : li) {
			System.out.println(pr.getTitle()+"-" + pr.getPrice() + "+==" + pr.getId());
		}
