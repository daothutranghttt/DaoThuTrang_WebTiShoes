...
import TiShoes.Model.Voucher_save;
...
public class Voucher_saveService {
	...
	public List<Voucher_save> getAllVoucher() {
		...
		try {
			...
			while (rs.next()) {
				...
				voucher_save.setQuanttity(rs.getInt("quantity"));
	...
	public static void main(String[] args) {
		Voucher_saveService s = new Voucher_saveService();
		System.out.println(s.get_id_voucher(16));
	}
