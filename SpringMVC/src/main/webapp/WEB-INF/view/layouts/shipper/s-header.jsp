...
<header>
        <div class="admin-header">
            ...
            <div class="admin-logo">
                <a href="/SpringMVC/shipper"><h2>Shipper</h2></a>
            </div>
            <div class="admin-search-form">
             ...
             <div class="admin-qrcode-icon">
                <img src="<c:url value="/assets/images/icons/icons8-scan-qr-code-78.png"/>" alt="icon-qr-code">
            </div>
