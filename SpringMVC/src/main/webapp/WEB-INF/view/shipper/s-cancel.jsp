...
<%@ page language="java" contentType="text/html; charset=UTF-8"
	pageEncoding="UTF-8"%>
<link rel="stylesheet" href="<c:url value='/assets/css/delivery.css'/>">
<style>
</style>
...
<c:if test="${ cancel == 'true' }">
	<div class="wrapper-background">
		<div class="status">
			...
			<h1>SUCCESSFUL CANCEL</h1>
		</div>
	</div>
</c:if>
<c:if test="${ cancel == 'false' }">
	<div class="wrapper-background">
		<div class="status">
			<img alt=""
	...
	<script type="text/javascript">
	    ...
	    scanner.addListener('scan',function(content){
	    	if(Number.isInteger(parseInt(content))) {
	    		 window.location.href="/SpringMVC/shipper/cancel-order/" +content;
	    	} else {
	    		 window.location.href="/SpringMVC/shipper/cancel-order/0";
	    	}
	    });
...
<c:if test="${ cancel == 'true' }">
	<script type="text/javascript">
		var delay = 1000; 
		setTimeout(function(){ window.location = "/SpringMVC/shipper"; }, delay);
	</script>
</c:if>
<c:if test="${ cancel == 'false' }">
	<script type="text/javascript">
		var delay = 1000; 
		setTimeout(function(){ window.location = "/SpringMVC/shipper/cancel-order"; }, delay);
	</script>
</c:if>
<script
