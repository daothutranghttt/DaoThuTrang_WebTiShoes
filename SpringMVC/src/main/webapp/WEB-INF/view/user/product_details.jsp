...
<body style="color: white;">
				...
				<div class="product-details-infor">
					...
					<div class="size-product-details">
						<div class="fit-guide-size">
							<p>Size</p>
							<a href="#" class="size-fit"> Size & Fit guide</a>
						</div>
	...
	<div class="wrap-size-fit none"></div>
	<div class="view-size-fit none">
		<div class="view-size-fit-wr">
			<img src="<c:url value="/assets/images/poster/sizefit.png"/>"
				alt="image">
				<div class="close-size-fit">
					<img src="<c:url value="/assets/images/icons/icons8-close-60.png"/>"
				alt="image">
				</div>
		</div>
	</div>
	...
	<script type="text/javascript">
		$(".size-fit").click(function() {
			$(".wrap-size-fit").removeClass("none");
			$(".view-size-fit").removeClass("none");
		});
		$(".close-size-fit").click(function() {
			$(".wrap-size-fit").addClass("none");
			$(".view-size-fit").addClass("none");
		});
	</script>
	...
	<script> // add to cart
		...
		if(id_user != "") {
			$("#add-to-cart-input").click(function() {
				...
				var xhr = new XMLHttpRequest();
				xhr.open("GET",
						"/SpringMVC/add-to-cart/"+id_user+"_"+id_prod+"_"+qty+"?process="+txt_size);
				xhr.onload = function() {
			...
			$("#add-to-cart-input").click(function() {
					...
					if (txt_size == "") {
						...
						var xhr = new XMLHttpRequest();
						xhr.open("GET",
								"/SpringMVC/cart?id="+id_prod+"&process="+txt_size+"&amount="+amount);
						xhr.onload = function() {
