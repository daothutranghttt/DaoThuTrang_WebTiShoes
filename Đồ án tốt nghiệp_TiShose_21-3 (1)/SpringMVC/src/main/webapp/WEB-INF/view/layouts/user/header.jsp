		...
		<c:if test="${ userID != null }">
			...
			<div class="dropdown-menu" aria-labelledby="dropdownMenuButton"
				...
				<div>
					...
					<a class="dropdown-item" href="/SpringMVC/personal-details/${ id_user }">Personal details</a> <a
				...
				<li><c:if test="${ id_user != null }">
					...
					<ul>
						<c:if test="${ userID == null }">
							...
							<li>
								<a href="" class="desktop-link menu">More</a>
								<ul class="more-shoes">
									<c:forEach var="li_style" items="${ style }" varStatus="index">
										<c:if test="${ index.getIndex() >= 9 }">
											<li><a class="menu"
						...
						<c:if test="${ userID != null }">
							<c:forEach var="li_style" items="${ style }" varStatus="index">
								<c:if test="${ index.getIndex() < 9 }">
									<li><a class="menu"
										href="http://localhost:8888/SpringMVC/products/${ id_user }?stylename=${ li_style.id }">${ li_style.style_name }</a></li>
								</c:if>
							</c:forEach>
							<li>
								<a href="" class="desktop-link menu">More</a>
